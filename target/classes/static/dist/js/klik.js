...
$("#tgl_lhr").val(document.getElementById ('f').value);
$("#umur").val(document.getElementById ('g').value);
$("#telp").val(document.getElementById ('h').value);
$("#tgl_berobat").val(document.getElementById ('i').value);
$("#Klinik").val(document.getElementById ('j').value);
$("#bayar").val(document.getElementById ('k').value);
$("#dokter").val(document.getElementById ('l').value);
